...
Based on our observations, fish length is a good predictor of fish weight for trout perch across all sample years (F1,288 = 1280.8, p \< 0.001, R2 = 0.8). For each 1 mm increase in fish length, we expect a 0.2 g increase in fish weight.
